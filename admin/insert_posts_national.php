...
<?php  
	...
	if(isset($_POST['submit']))
	{
		...
		if($posts_title=='' or $posts_content=='' or $posts_author=='' or $posts_image=='' /*or $posts_date==''*/)
		{
		...
		else
		{
			...
			$insert_query = "insert into national (Post_Title,Post_Author,Post_Image,Post_Content) values ('$posts_title','$posts_author','$posts_image','$posts_content')";
