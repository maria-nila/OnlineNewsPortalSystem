<?php
	...
	if(isset($_GET['edit']))
	{
		...
		$edit_query = "select * from national where Id = $edit_id";
...
<html>
	...
	<body>
		...
		<div class="main_content-insert">
			...
			<form method = "post" action = "update_posts_national.php?edit_form=<?php echo $edit_id; ?>" enctype = "multipart/form-data" >
				<table width = "500" align = "center" style="box-shadow: 8px 8px; border: 5px solid black;">
					<tr>
						<td align = "center" bgcolor = "#D1BDB3" colspan = "6">
							<h2>Update New Post For National</h2>
						</td>
					</tr>
...
<?php
	...
	if(isset($_POST['update']))
	{
		...
		else
		{
			...
			$update_query = "update national set Post_Title='$posts_title1', Post_Author='$posts_author1', Post_Image='$posts_image1', Post_Content='$posts_content1' where Id='$update_id'";
