...
<?php  
	...
	if(isset($_POST['submit']))
	{
		...
		else
		{
			...
			$insert_query = "insert into sports (Post_Title,Post_Author,Post_Image,Post_Content) values ('$posts_title','$posts_author','$posts_image','$posts_content')";
