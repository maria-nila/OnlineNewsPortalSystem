<?php
	...
	if(isset($_GET['edit']))
	{
		...
		$edit_query = "select * from international where Id = $edit_id";
...
<html>
	...
	<body>
		...
		<div class="main_content-insert">
			...
			<form method = "post" action = "update_posts_international.php?edit_form=<?php echo $edit_id; ?>" enctype = "multipart/form-data" >
...
<?php
	...
	if(isset($_POST['update']))
	{
		...
		else
		{
			...
			$update_query = "update international set Post_Title='$posts_title1', Post_Author='$posts_author1', Post_Image='$posts_image1', Post_Content='$posts_content1' where Id='$update_id'";
