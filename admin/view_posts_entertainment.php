...
<html>
	...
	<div class="main_content-insert">
		...
		<p style="padding-left: 365px;"><b>View Posts Form Entertainment Table</b></p>
		...
		<?php 
			...
			$select_query = "select * from entertainment order by 1 DESC";
		...
		<tr align= "center">
			...
			<td><a href = "delete_posts_entertainment.php?delete=<?php echo $posts_id; ?>">Delete</a></td>
			<td><a href = "update_posts_entertainment.php?edit=<?php echo $posts_id; ?>">Update</a></td>
