...
<html>
	...
	<body>
		...
		<div class="main_content-insert">
			...
			<form method = "post" action = "insert_posts_entertainment.php" enctype = "multipart/form-data" >
				<table width = "500" align = "center" style="box-shadow: 8px 8px; border: 5px solid black;">
					<tr>
						<td align = "center" bgcolor = "#D1BDB3" colspan = "6">
							<h2>Insert New Post For Entertainment</h2>
						</td>
					</tr>
...
<?php  
	...
	if(isset($_POST['submit']))
	{
		...
		else
		{
			...
			$insert_query = "insert into entertainment (Post_Title,Post_Author,Post_Image,Post_Content) values ('$posts_title','$posts_author','$posts_image','$posts_content')";
